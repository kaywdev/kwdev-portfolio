	...
	<div class="entry-content">
		...
		<div class="design-wrapper">
			...
			<div class="design-img-wrapper col-2" data-aos="fade-up">
				<div class="hl-img2"><?php if($design_image_id_1): echo wp_get_attachment_image($design_image_id_1, 'large', '', array('class'=>'project-img')); endif; ?></div>	
				<div class="hl-img2"><?php if($design_image_id_2): echo wp_get_attachment_image($design_image_id_2, 'large', '', array('class'=>'project-img'));endif; ?></div>
			</div>
			
			<div class="design-img-wrapper hl-mq-grid">
				<div class="design-text-wrapper" data-aos="fade-right"><?php if($design_text_2): echo $design_text_2; endif; ?></div>
				<div class="design-img-wrapper hl-third-img" data-aos="fade-up">
					<?php if($design_image_id_3): echo wp_get_attachment_image($design_image_id_3, 'large', '', array('class'=>'project-img'));endif; ?>
				</div><!-- .hl-third-img -->
			</div><!-- .hl-mq-grid -->
			...
			<div class="design-img-wrapper hl-forth-img" id="hl-forth-img" data-aos="fade-up">
				<?php if($design_image_id_4): echo wp_get_attachment_image($design_image_id_4, 'full', '', array('class'=>'project-full-img'));endif; ?>
			</div><!-- .ln-forth-img -->
		</div> <!-- .design-wrapper -->
		...
		<div class="dev-wrapper">
			<div class="dev-section dev1">
				<div class="dev-inner-wrapper">
					...
					<div class="dev-img-wrap" data-aos="fade-up"><?php if($dev_image_id_2): echo wp_get_attachment_image($dev_image_id_2, 'large', '', array('class'=>'dev-img'));endif; ?>
					</div><!-- ..dev-img-wrap -->
					<div class="dev-git hl-dev1-git"  data-aos="fade-up">
					<script src="https://gist.github.com/kaywdev/1886957255ff9b54d0d9a49cb1f037f5.js"></script>
					</div><!-- .dev-git.hl-dev1-gi -->
			...
			<div class="dev-section dev2">
				<div class="dev-inner-wrapper">
					...
					<script src="https://gist.github.com/kaywdev/dd0df02c5aea61f6ba6b11b4d314d729.js"></script>
