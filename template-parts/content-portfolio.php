	...
	<div class="entry-content">
		...
		<div class="design-wrapper">
			<div class="project-first-img" data-aos="fade-up">
				...
				?>
			<div class="design-img-wrapper hl-second-img pf-second-img" data-aos="fade-up">
			...
			<div class="pf-text-wrapper" data-aos="fade-up">
			<div class="design-text-wrapper"><?php if($design_text_1): echo $design_text_1; endif; ?></div>
			<div class="design-text-wrapper"><?php if($design_text_2): echo $design_text_2; endif; ?></div>
			</div>
		...
		<div class="dev-text-wrapper" data-aos="fade-up"><?php if($dev_text_1): echo $dev_text_1; endif; ?></div>
			<div class="pf-dev1">	
			<div class="dev-inner-wrapper" data-aos="fade-up">	
				<div class="dev-img-wrap"><?php if($dev_image_id_1): echo wp_get_attachment_image($dev_image_id_1, 'large', '', array('class'=>'dev-img'));endif; ?></div>
				<div class="dev-img-wrap"><?php if($dev_image_id_2): echo wp_get_attachment_image($dev_image_id_2, 'large', '', array('class'=>'dev-img'));endif; ?></div>
			</div><!-- .ln-dev1 -->
			</div>
		</div><!-- .dev-wrapper -->
