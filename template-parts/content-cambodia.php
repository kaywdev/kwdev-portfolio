	...
	<div class="entry-content">
		...
		<div class="design-wrapper">
			<div class="project-first-img" data-aos="fade-up">
				...
				?>
			<div class="design-img-wrapper cc-second-img" data-aos="fade-up">
				<?php if($design_image_id_1): echo wp_get_attachment_image($design_image_id_1, 'large', '', array('class'=>'project-img')); endif; ?>	
			</div><!-- .tg-second-img -->

			<p><?php if($design_text_1): echo $design_text_1; endif; ?></p>
			<p><?php if($design_text_2): echo $design_text_2; endif; ?></p>
			...
			<div class="design-img-wrapper cc-third-img" data-aos="fade-up">
				<?php if($design_image_id_2): echo wp_get_attachment_image($design_image_id_2, 'large', '', array('class'=>'project-img'));endif; ?>
			</div><!-- .tg-third-img -->
		...
		<div class="dev-wrapper">
			...
			<div class="dev-inner-wrapper cc-dev1">
				<p data-aos="fade-up"><?php if($dev_text_1): echo $dev_text_1; endif; ?></p>
				<div class="dev-movie" data-aos="fade-up">
					<video width="100%" height="100%" controls preload="metadata">
					<source src="<?php echo get_template_directory_uri(); ?>/media/country/cc-dev1.mp4#t=0.1" type="video/mp4" alt="Cambodia responsive demo">
					</video>
					</div><!-- .dev-movie -->
			</div><!-- .cc-dev1 -->
